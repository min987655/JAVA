...
public class Protocol {
	public static final String REGISTER = "100"; // 회원가입(requst)
	public static final String IDSEARCH = "110"; // ID찾기 Join(requst)
	public static final String IDSEARCH_OK = "111"; // ID찾기 기존에 있는거(ACK)
	public static final String IDSEARCH_NO = "112"; // ID찾기 기존에 없음(NACK)
	public static final String IDSEARCHCHECK = "113"; // (using 회원가입)ID찾기 중복확인(requst)
	public static final String IDSEARCHCHECK_OK = "114"; // (using 회원가입)ID찾기 중복확인(사용가능)(ACK)
	public static final String IDSEARCHCHECK_NO = "115"; // (using 회원가입)ID찾기 중복확인(사용불가능)(NACK)
	public static final String ENTERLOGIN = "120"; // 로그인(requset)
	...
	public static final String SENDMASSAGE_ACK = "410"; // 메세지 보내기(답장)
